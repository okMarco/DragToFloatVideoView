package com.hochan.dragtofloatvideoview.statusbar;
...
/**
 * .
 * Created by hochan on 2018/1/27.
 */
...
public class StatusBarCompat {
	...
	static {
		...
		} else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && !PhoneSystemCompat.isEMUI()) {
